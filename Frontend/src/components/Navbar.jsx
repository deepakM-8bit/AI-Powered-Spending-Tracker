...
export default function Navbar({ showUserActions = true }) {
  ...
  return (
    ...
    >
      ...
      <Link
        to="/"
        className="opening-show flex items-center text-xl font-bold tracking-tight text-gray-900 dark:text-gray-100 md:text-3xl hover:opacity-90"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 16 16"
          fill="currentColor"
          className="mr-1 my-auto size-5"
        >
          <path
            fillRule="evenodd"
          ...
          {theme === "dark" ? (
            ...
            >
              ...
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 2v2m0 16v2m8-10h2M2 12h2m14.1-7.1l1.4 1.4M4.5 19.5l1.4-1.4m12 0l1.4 1.4M4.5 4.5l1.4 1.4"
              />
            </svg>
          )}
        </button>
